...
<!-- Affichage -->
	<div class="container">
     ...
     if(move_uploaded_file($_FILES['file']['tmp_name'], $dossier . $id_next . $fichier)){
     ...
     elseif(move_uploaded_file($_FILES['thumb']['tmp_name'], $dossier . $id_next . $fichier2))  //Si la fonction renvoie TRUE, c'est que ça a fonctionné...
    {
     	$image= $donnee['image'];
